...
// Client Array
const clients = [
  { id: 1, name: "Apple", logo: AppleIcon, description: "Platform Engineering" },
  { id: 2, name: "Vercel", logo: VercelIcon, description: "Frontend Development" },
  { id: 3, name: "Supabase", logo: SupabaseIcon, description: "Database Architecture" },
  { id: 4, name: "TypeScript", logo: TypeScriptIcon, description: "Type System Design" },
];
